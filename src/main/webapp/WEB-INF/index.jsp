...
<br>
    ...
    <h5 id="count" style="float: right; margin-right: 20px">
    </h5>
    ...
    <div>
        <ul id="pagging-bar" class="pagination pagination-sm justify-content-center">
            <c:forEach begin="1" end="${pagesCount+1}" step="1" varStatus="i">
                <c:if test="${pagesCount > 1}">
                    <li class="page-item disabled">

                        <c:url value="/rest/ships" var="url">
                            <c:param name="pageNumber" value="${i.index-1}"/>
                        </c:url>
                        <c:if test="${pageNumber == (i.index-1)}">
                        <a class="page-link" href="${url}" tabindex="-1">${i.index}</a>
                        </c:if>
                    <c:if test="${pageNumber != (i.index-1)}"><li class="page-item"><a class="page-link" href="${url}">${i.index}</a></li></c:if>
                    </li>
                </c:if>
            </c:forEach>
        </ul>
